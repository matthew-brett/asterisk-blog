---
title: I've been reflecting from time to time on the mystery of Hadley Wickham's "Readings
  in Applied Data Science" at Stanford
aliases:
- /i-ve-been-reflecting.html
date: 2018-06-05 11:30
categories:
- G+ archive
---
...
\
The mystery is the only not-optional reading for the first week on
\"What the \*&!% is data science?\". It\'s a very short blog post with
title \"Data scientists mostly do arithmetic and that\'s a good thing\":
...
one of the optional readings like Donoho\'s big and thoughtful \"50
...
industry, are \"data hackers\", the data equivalent of the hacker
movement in computing. They improvise, they invent, they build, they
share.\
\
...
saw how they could apply them. Now let\'s work out what we should teach.


The Google+ URL for this post was `https://plus.google.com/+MatthewBrett/posts/gZAtY9bMAUR`
