...
I summarized some results of the 2018 survey in [Python,
Matlab, R, Julia](/posts/python-matlab-r-julia/).  Here
are the equivalent results for the 2019 survey.  See the
previous post for definitions, and other background.
...
inclusive, and diverse"; maybe the change in results corresponds to a change
in the sample.  I'll have a look at the full database, when they release it.

**Update**; now I look at the [released
files](https://insights.stackoverflow.com/survey), neither Matlab nor Julia
appears as an option for any question in 2019.
