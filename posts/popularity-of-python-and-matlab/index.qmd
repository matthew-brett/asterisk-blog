...
aliases:
- /popularity-of-python-and-matlab.html
...
> universities. However, Python’s growth is spread pretty evenly across
> industries.
...
See a [previous post](/posts/hows-julia/) for an introduction to the
...
See the [previous post](/posts/hows-julia/) for an introduction to
