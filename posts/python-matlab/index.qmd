...
- open source
- free software
description: Comparing Python and Matlab for Psychology teaching
keywords:
- Matlab
- Python
---

See also [Python, Matlab, R, Julia](/posts/python-matlab-r-julia/).
...
computing
languages](http://asterisk.dynevor.org/which-programming-language-should.html).
