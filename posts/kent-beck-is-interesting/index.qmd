---
title: Kent Beck is interesting on the change in culture from the old days, where
  programmers wrote code and the quality assessment people tested it, to the current
  practice, where the programmer takes responsibility for the quality of their own
  code
aliases:
- /kent-beck-is-interesting.html
