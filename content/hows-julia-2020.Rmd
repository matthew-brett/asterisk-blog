...
Here are the values for Python, R and Julia for the last two years:
...
The overall pattern over the last few years could be steady growth of around 0.01% per year.  By contrast, Python appears to be growing at around 1% per year:
