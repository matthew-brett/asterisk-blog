...
It's time to call it — I don't think the Julia language is going to make it into the data analysis mainstream.

You'll see the evidence for this below.  In summary, there is now some
evidence, particularly from Stack Overflow trends, and the Popularity of
Programming Languages site, that Julia uptake has plateaued.

Some people hoped that Julia would be the One Language to Rule Them All, at
least in science.  In order to get there, it need to have a plausible shot at
competing with Python, and to do that, it would need to grow quickly.
...
This is a further update from my previous two posts on uptake and activity for
...
* Commits on the main Julia repository have been flat since mid 2018.
...
The subheading below mostly match those from the previous posts.  See those
...
![](image/google_trends_2022_07.png)
